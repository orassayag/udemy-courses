class CountLimitData {
	...
	constructor(settings) {
		...
		const { MAXIMUM_COURSES_PURCHASE_COUNT, MILLISECONDS_TIMEOUT_SOURCE_REQUEST_COUNT, MAXIMUM_PAGES_NUMBER,
			...
			MAXIMUM_PURCHASE_ERROR_IN_A_ROW_COUNT } = settings;
		...
		this.maximumGetErrorInARowCount = MAXIMUM_GET_ERROR_IN_A_ROW_COUNT;
