class CountLimitDataModel {
	...
	constructor(settings) {
		...
		const { MAXIMUM_COURSES_PURCHASE_COUNT, MILLISECONDS_TIMEOUT_SOURCE_REQUEST_COUNT, MAXIMUM_SESSIONS_COUNT, MILLISECONDS_INTERVAL_COUNT,
			MILLISECONDS_TIMEOUT_BETWEEN_COURSES_CREATE, MILLISECONDS_TIMEOUT_BETWEEN_COURSES_MAIN_PAGES, MILLISECONDS_TIMEOUT_BETWEEN_COURSES_UPDATE,
			MAXIMUM_COURSE_NAME_CHARACTERS_DISPLAY_COUNT, MAXIMUM_URL_CHARACTERS_DISPLAY_COUNT, MAXIMUM_RESULT_CHARACTERS_DISPLAY_COUNT,
			MILLISECONDS_TIMEOUT_UDEMY_ACTIONS, MAXIMUM_UDEMY_LOGIN_ATTEMPTS_COUNT, MILLISECONDS_TIMEOUT_BETWEEN_COURSES_PURCHASE,
			MILLISECONDS_TIMEOUT_UDEMY_PAGE_LOAD, MAXIMUM_CREATE_UPDATE_ERROR_IN_A_ROW_COUNT, MAXIMUM_PURCHASE_ERROR_IN_A_ROW_COUNT,
			MILLISECONDS_TIMEOUT_EXIT_APPLICATION, MAXIMUM_URL_VALIDATION_COUNT, MILLISECONDS_TIMEOUT_URL_VALIDATION } = settings;
